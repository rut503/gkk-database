...
cursor
A pointer to the result set of a query (Collection of addresses of docuemnts). Clients can iterate through a cursor to retrieve results. By default, cursors
