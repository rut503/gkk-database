...
db.reviewForConsumer.deleteMany({});
db.reviewForFoodItem.deleteMany({});
...
var foodCursor = db.foodItem.find({});
...
db.reviewForProducer.insertMany([
    {
...
db.reviewForConsumer.insertMany([
    {
        consumerId: consumerMap.get('Octovio'),
        producerId: producerMap.get('Bob'),
        rating: 5,
...
db.reviewForFoodItem.insertMany([
    {
        foodItemId: foodMap.get('Jenna\'s Vegan Blueberry Cookies')._id,
        consumerId: consumerMap.get('Octovio'),
        rating: 5,
